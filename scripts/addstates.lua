local bestiary_openstate = GLOBAL.State{
	name = "bestiary_open",
	tags = { "doing" },
	...
	events = {
		GLOBAL.EventHandler("ms_closepopup", function(inst, data)
...
local bestiary_closestate = GLOBAL.State{
	name = "bestiary_close",
	tags = { "idle", "nodangle" },
...
local bestiary_open_clientstate = GLOBAL.State{
	name = "bestiary_open",
	tags = { "doing" },
