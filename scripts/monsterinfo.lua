...
function ReloadBestiaryData() -- Reload base game mob data
    local data = {
        {
            scale = 0.2,
    ...
    for i, data in ipairs(data) do
        if data.forms then
            MONSTERDATA_BESTIARY[data.forms[1].prefab] = data
        else
            MONSTERDATA_BESTIARY[data.prefab] = data
        end
    end
end

function AddToBestiary(mob_data)
    for i, data in ipairs(mob_data) do
        if data.forms then
            MONSTERDATA_BESTIARY[data.forms[1].prefab] = data
        else
            MONSTERDATA_BESTIARY[data.prefab] = data
